...
public class FreeFloatingActionButton extends View {
    ...
    public FreeFloatingActionButton(Context context) {
        super(context);
    ...
    static public class Builder {
        ...
        public FreeFloatingActionButton create() {
            final FreeFloatingActionButton button = new FreeFloatingActionButton(activity);
