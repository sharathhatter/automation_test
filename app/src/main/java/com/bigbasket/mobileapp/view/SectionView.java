...
public class SectionView {
    ...
    public SectionView(Context context, SectionData mSectionData) {
        this.context = context;
        this.mSectionData = mSectionData;
    }
    ...
    private View getCarouselView(Section section, LayoutInflater inflater, int layoutId,
        ...
        if (section.getSectionType().equals(Section.TEXT_CAROUSEL)) {
            TextCarouselAdapter textCarouselAdapter = new TextCarouselAdapter<>(context, section, mSectionData.getRenderersMap(),
    ...
    private View getMenuView(Section section, LayoutInflater inflater) {
        ...
        int layoutMargin = (int) context.getResources().getDimension(R.dimen.margin_small);
    ...
    private View getTileView(Section section, LayoutInflater inflater) {
        LinearLayout tileContainer = new LinearLayout(context);
