...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private int mButtonSpacing, mColorNormal, mColorPressed;
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mAddButtonColorNormal = getColor(R.color.uiv3_action_bar_background);
        mAddButtonColorPressed = getColor(R.color.uiv3_action_bar_background);
        ...
        if (attributeSet != null) {
            ...
            if (attr != null) {
                try {
                    ...
                    mAddButtonColorNormal = attr.getColor(R.styleable.FloatingActionsMenu_addButtonColorNormal, getColor(R.color.uiv3_action_bar_background));
                    mAddButtonColorPressed = attr.getColor(R.styleable.FloatingActionsMenu_addButtonColorPressed, getColor(R.color.uiv3_action_bar_background));
                } finally {
                    attr.recycle();
                }
            }
    ...
    private void createAddButton(Context context) {
        ...
        mAddButton.setImageResource(R.drawable.login_arrow);  // icon
    ...
    public void toggle() {
        if (mExpanded) {
            mAddButton.setImageResource(R.drawable.login_arrow);
            collapse();
        } else {
            mAddButton.setImageResource(R.drawable.arrow_back);
            expand();
        }
//        Animation rotation = AnimationUtils.loadAnimation(context, R.anim.button_rotate);
//        rotation.setRepeatCount(Animation.INFINITE);//ABSOLUTE
//        mAddButton.startAnimation(rotation);
    }
