...
public class TrackEventkeys {
    ...
    public static final String PRODUCT_TOP_CAT = "p_top_cat";
    public static final String QUERY = "query";
    public static final String DATE_FROM = "date_from";
    public static final String DATE_TO = "date_to";
    public static final String GET_BASKET_CALL = "get basket call";
    public static final String EMPTY_BASKET_CALL = "empty basket call";
    public static final String EMPTY_MEMBER_PIN = "get member pin";
...
//    public static final String MO_APP_ID =D6Y5AVT60X4AWNLL35EIDJ";
