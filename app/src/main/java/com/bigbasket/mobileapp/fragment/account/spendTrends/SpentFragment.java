...
public class SpentFragment extends BaseSpendTrendsFragment {
    ...
    private void displayBarChart(ArrayList<SpendTrendsRangeData> filteredSpentSavedRangeData,
        ...
        for (int i = 0; i < filteredSpentSavedRangeData.size(); i++) {
            series.add(i, filteredSpentSavedRangeData.get(i).getSpent());
        }
        ...
        multipleSeriesRenderer.setChartTitle(getString(R.string.howMuchSpent));
        multipleSeriesRenderer.setXTitle(categoryName);
        multipleSeriesRenderer.setYTitle("Amount in Rs");
