...
public class WalletActivityListAdapter<T> extends BaseAdapter {
    ...
    public WalletActivityListAdapter(T ctx, ArrayList<WalletDataItem> listData, Typeface faceRobotoRegular,
        ...
        layoutInflater = LayoutInflater.from(((AppOperationAware) ctx).getCurrentActivity());
        this.ctx = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String prefixEndBal = (((AppOperationAware) ctx)).getCurrentActivity().getString(R.string.endingBal) + " `";
        ...
        if (walletDataItems.get(position).getType().equals("credit")) {
            String prefix = ((AppOperationAware) ctx).getCurrentActivity().getString(R.string.credited) + " `";
